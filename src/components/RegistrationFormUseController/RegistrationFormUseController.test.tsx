...
import RegistrationFormUseController from './RegistrationFormUseController';

describe('RegistrationForm', () => {
    it('should render', () => {
        const { container } = render(<RegistrationFormUseController />);
    ...
    it('should show error message when email is not provided', async () => {
        render(<RegistrationFormUseController />);
